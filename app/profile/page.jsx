...
const Page = () => {
  ...
  return (
    <>
   <div
      className="bg-white p-6 shadow-[0_2px_15px_-6px_rgba(0,0,0,0.2)] w-full max-w-sm rounded-2xl font-[sans-serif] overflow-hidden mx-auto mt-4">
      <div className="flex flex-col items-center">
        <img src='https://picsum.photos/200' className="w-28 h-w-28 rounded-full" />
        <div className="mt-4 text-center">
          <p className="text-xl text-[#333] font-extrabold">{user.name}</p>
