...
const AddTodoForm = () => {
  ...
  <input value={title} onChange={(e) => setTitle(e.target.value)} type="text" placeholder="Todo Title" className=" bg-slate-800 text-white w-full rounded-lg px-3 py-2 focus:outline-none focus:ring focus:ring-blue-500 focus:ring-opacity-50 font-bold" />
  <textarea value={description} onChange={(e) => setDescription(e.target.value)} type="text"  rows="5" placeholder="Todo Description" className="bg-slate-900 text-white w-full rounded-lg px-3 py-2 focus:outline-none focus:ring focus:ring-blue-500 focus:ring-opacity-50 font-bold"></textarea>
